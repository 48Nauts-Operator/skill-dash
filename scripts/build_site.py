...
<link rel="icon" href="/favicon.svg"><link rel="stylesheet" href="/css/style.css?v=11"><script defer src="/js/main.js?v=5"></script>
...
<figure class="shot"><a href="/img/dashboard.png"><img src="/img/dashboard.png" width="1440" height="1000" alt="The skill-dash dashboard: judged skills, recommended actions, usefulness distribution, sortable table with evidence and overlap per skill" loading="lazy"></a><figcaption>The dashboard, here on a public repo of 38 skills: every row judged, the recommended action, usefulness, overlap partner, and your decision. Click a row for the evidence, the Jev distributions and the radar.</figcaption></figure>
