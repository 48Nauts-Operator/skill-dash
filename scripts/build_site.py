...
<p>Two repositories. This site and its data files live at <a href="https://github.com/48Nauts-Operator/whichskills-website">github.com/48Nauts-Operator/whichskills-website</a>. The pipeline that produced them, the crawler, the static pre-scan, the Jev judge and the local dashboard, is <a href="https://github.com/48Nauts-Operator/skill-dash">github.com/48Nauts-Operator/skill-dash</a>. Run it on your own tree with <code>python3 server.py --roots &lt;dir&gt;</code>; nothing leaves your machine except the Jev calls you choose to make. The verbatim Jev questions above are already the ones the pipeline sends. Data files: <a href="/data/report.json">report</a>, <a href="/data/clones.json">clones</a>, <a href="/data/jev-risk.json">jev-risk</a>, <a href="/data/corpus.json">corpus</a>, CC BY 4.0.</p></section>
