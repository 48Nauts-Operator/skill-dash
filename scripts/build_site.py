...
<article class="card"><div class="eyebrow">3 · UPGRADE YOUR SKILLS</div><h3>Then let the corpus add what fits</h3><p>The Upgrade view profiles your tree locally (your CLAUDE.md, your skills, what you use; your recent prompts only if you opt in), cuts the {total_skills:,}-skill index to the closest 200, fetches each at its pinned commit, and has Jev read every one against your profile: does it fill a gap you actually have, and do you already own a twin. Ranked by fit discounted by twin probability, with the install command per row. Nothing is written to your tree.</p><p class="why"><b>Why it matters.</b> A skill you searched for and read beats ten you were handed. A run costs a few cents and takes about a minute.</p></article>
</div></section>
